            ...
            <motion.div variants={staggerContainer(0.1, 0.1)} initial="hidden"
                ...
                <div className="flex justify-center items-center flex-col relative z-20 pb-5">
                    ...
                    <motion.div variants={textVariant(1.5)}>
                        <p className={`text-white bg-${cores?.primaria ? 'transparent' : 'black/70'} rounded-4xl p-4 fw-bold text-center mt-5 md:mt-0 text-[30px] leading-[40px] lg:text-[40px] lg:leading-[50px] px-[20px] md:px[100px] lg:px-[200px] md:text-center`}>
                            {text}
                        </p>
                    </motion.div>
                </div>
