        ...
        <div key={id} className='flex-[0_0_100%] min-w-0 md:flex-[0_0_calc(100%/2)] px-3'>
            <article className='bg-[#1e293b] p-6 rounded-lg text-white space-y-4 h-full flex flex-col'>
                ...
                <div className='flex-1 flex-col items-start justify-between select-none'>
                    <h3 className='text-[25px] uppercase font-bold text-[#1e293b] mb-2 text-center bg-gray-300 rounded-b-xl'>{title}</h3>
                    <p className='text-gray-100 text-lg text-center py-2'>
