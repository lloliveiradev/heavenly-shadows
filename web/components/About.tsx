...
export default function About({ cores }) {
    ...
    Potter. Leo tem sido um grande admirador da magia, do universo e da espiritualidade, se interessando e
    ...
    processo de escrita utilizando personas que traduzem visões e momentos distintos da sua vida pessoal para discorrer sobre
    ...
    Em 2019, Leo começou a publicar online sua primeira obra, intitulada "Sombras de um vislumbre Celeste", que reúne poesias escritas ao longo
